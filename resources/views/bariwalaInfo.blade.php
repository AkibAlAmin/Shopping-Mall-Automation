<div>
    <form action="{{url('viewInfo')}}" method="POST">
        {{ csrf_field() }}
<div>
<input type="number" name="Bid" placeholder="Put a Random ID" required value="{{ old('Bid') }}"/>
</div>

<div>
    <input type="text" name="Bname" placeholder="Put a Name" required value="{{ old('Bname') }}"/>
</div>

<div>
    <input type="text" name="Badd" placeholder="Put Full Address"/>
</div>

<div>
    <input type="text" name="Bcontact" placeholder="Put Mobile Number"/>
</div>


<div>
    <input type="email" name="Bmail" placeholder="Put email Address"/>
</div>

<div>
    <button type="submit" value="submit" name="sign">Submit</button>
</div>
    </form>
</div>
                        ...
                        <div class="card-body">
                            <form action="{{url('viewinfo')}}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="present_address" name="present-address" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="phone_number" name="phone-number" class="form-control">
                                    </div>
                                </div>
